...
// PointOfServiceWsDTO point of service ws d t o
// swagger:model PointOfServiceWsDTO
type PointOfServiceWsDTO struct {
...
// Validate validates this point of service ws d t o
func (m *PointOfServiceWsDTO) Validate(formats strfmt.Registry) error {
	var res []error
...
func (m *PointOfServiceWsDTO) validateAddress(formats strfmt.Registry) error {
...
func (m *PointOfServiceWsDTO) validateGeoPoint(formats strfmt.Registry) error {
...
func (m *PointOfServiceWsDTO) validateMapIcon(formats strfmt.Registry) error {
...
func (m *PointOfServiceWsDTO) validateOpeningHours(formats strfmt.Registry) error {
...
func (m *PointOfServiceWsDTO) validateStoreImages(formats strfmt.Registry) error {
...
func (m *PointOfServiceWsDTO) MarshalBinary() ([]byte, error) {
	if m == nil {
		return nil, nil
	}
...
func (m *PointOfServiceWsDTO) UnmarshalBinary(b []byte) error {
	var res PointOfServiceWsDTO
